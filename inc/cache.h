...
class CACHE : public MEMORY {
  public:
    ...
    uint64_t sim_access[NUM_CPUS][NUM_CTX][NUM_TYPES],
             sim_hit[NUM_CPUS][NUM_CTX][NUM_TYPES],
             sim_miss[NUM_CPUS][NUM_CTX][NUM_TYPES],
             roi_access[NUM_CPUS][NUM_CTX][NUM_TYPES],
             roi_hit[NUM_CPUS][NUM_CTX][NUM_TYPES],
             roi_miss[NUM_CPUS][NUM_CTX][NUM_TYPES];
